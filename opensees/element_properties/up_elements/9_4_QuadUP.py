...
def makeXObjectMetaData():
	...
	at_thick.description = (
		...
		html_par(html_href('http://opensees.berkeley.edu/wiki/index.php/Nine_Four_Node_Quad_u-p_Element','Nine Four Node Quad u-p Element')+'<br/>') +
		html_end()
		)
	...
	at_bulk.description = (
		...
		html_par('Combined undrained fBulk modulus Bc relating changes in pore pressure and volumetric strain, may be approximated by:') +
		html_par('Bc ≈ Bf/n') +
		html_par('where Bf is the fBulk modulus of fluid phase (2.2x10^6 kPa (or 3.191x10^5 psi) for water), and n the initial porosity.') +
		html_par(html_href('http://opensees.berkeley.edu/wiki/index.php/Nine_Four_Node_Quad_u-p_Element','Nine Four Node Quad u-p Element')+'<br/>') +
		html_end()
		)
...
def getNodalSpatialDim(xobj, xobj_phys_prop):
	return [(2,3),(2,3),(2,3),(2,3),(2,2),(2,2),(2,2),(2,2),(2,2)]	# ndm, ndf
...
def writeTcl(pinfo):
	...
	fBulk = get_attr('fBulk').quantityScalar.value
	...
	pinfo.out_file.write(
		'{}element 9_4_QuadUP {} {} {} {} {} {} {} {} {}\n'.format(
			pinfo.indent, tag, nstr, thick, matTag, fBulk, fmass, hPerm, vPerm, sopt)
		)
