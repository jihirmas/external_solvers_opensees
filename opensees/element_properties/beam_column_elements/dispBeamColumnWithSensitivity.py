...
def makeXObjectMetaData():
	...
	xom.name = 'dispBeamColumnWithSensitivity'
...
def writeTcl(pinfo):
	...
	# element dispBeamColumnWithSensitivity $eleTag $iNode $jNode $numIntgrPts $secTag $transfTag
	# <-iter numIter tol> <-mass $massDens> <-cMass> <-integration $intType>
	
	# element dispBeamColumnWithSensitivity $eleTag $iNode $jNode $numIntgrPts -sections $secTag1 $secTag2 ... 
	# $transfTag <-iter numIter tol> <-mass $massDens> <-cMass> <-integration $intType>
