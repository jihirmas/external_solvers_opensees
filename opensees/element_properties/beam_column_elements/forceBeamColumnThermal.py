...
def makeXObjectMetaData():
	...
	at_Dimension.description = (
		...
		html_par(html_href('http://openseesforfire.github.io/Subpages/Examples/simply_beam.html','forceBeamColumnThermal')+'<br/>') +
		html_end()
		)
	...
	at_cMass.description = (
		...
		html_par(html_href('http://opensees.berkeley.edu/wiki/index.php/Force-Based_Beam-Column_Element','forceBeamColumnThermal')+'<br/>') +
		html_end()
		)
	
	xom = MpcXObjectMetaData()
	xom.name = 'forceBeamColumnThermal'
...
def writeTcl(pinfo):
	...
	# element forceBeamColumnThermal $eleTag $iNode $jNode $transfTag "IntegrationType arg1 arg2 ..." <-mass $massDens> <-iter $maxIters $tol>
