...
def writeTcl(pinfo):
	# element quadWithSensitivity $eleTag $iNode $jNode $kNode $lNode $thick $type $matTag <$pressure $rho $b1 $b2>
	...
	if not namePh.startswith('materials.nD'):
		raise Exception ('Error: materials must be nD')
	...
	if Optional:
		...
		pressure = pressure_at.quantityScalar.value
	...
	str_tcl = '{}element quadWithSensitivity {} {} {} {} {} {}\n'.format(pinfo.indent, tag, nstr, thick, type, matTag, sopt)
