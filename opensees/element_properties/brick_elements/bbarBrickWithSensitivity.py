...
def makeXObjectMetaData():
	...
	xom.name = 'bbarBrickWithSensitivity'
...
def writeTcl(pinfo):
	...
	#element bbarBrickWithSensitivity $eleTag $node1 $node2 $node3 $node4 $node5 $node6 $node7 $node8 $matTag <$b1 $b2 $b3>
	...
	str_tcl = '{}element bbarBrickWithSensitivity {}{} {} {}\n'.format(pinfo.indent, tag, nstr, matTag, sopt)
