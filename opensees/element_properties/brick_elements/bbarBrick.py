...
def makeXObjectMetaData():
	...
	at_Optional.description = (
		...
		html_par(html_href('http://opensees.berkeley.edu/wiki/index.php/Bbar_Brick_Element','Bbar Brick Element')+'<br/>') +
		html_end()
		)
...
def getNodalSpatialDim(xobj, xobj_phys_prop):
	return [(3,3),(3,3),(3,3),(3,3),(3,3),(3,3),(3,3),(3,3)]	#(ndm, ndf)
