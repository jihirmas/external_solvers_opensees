...
def _get_command_params(xobj):
	...
	if use_rayleigh:
		...
		rayleigh = ''
		rayleigh2 = ''
	return (truss, rayleigh, rayleigh2, rho)
...
def makeXObjectMetaData():
	...
	at_rayleigh.description = _description('-rayleigh', 'check it to activate rayleigh damping')
	
	xom = MpcXObjectMetaData()
	xom.name = 'N4BiaxialTruss'
...
def writeTcl(pinfo):
	...
	# This is a macro-element, a 4 node quad in STKO, that generates an assembly N4BiaxialTruss elements in TCL.
	...
	truss, rayleigh, rayleigh2, rho = _get_command_params(xobj)
	...
	# diagonal concrete
	pinfo.out_file.write('{}element N4BiaxialTruss {}   {} {} {} {}   {} {}{}{}; # diagonal concrete \n'.format(pinfo.indent, concr_ele_id_d1, i1, i3, i2, i4, area_concr_diag, mat_id_concr_diag, rho, rayleigh2))
