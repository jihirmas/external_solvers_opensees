...
def makeXObjectMetaData():
	...
	at_mu.description = (
		...
		html_par(html_href('http://opensees.berkeley.edu/wiki/index.php/ContactMaterial3D','ContactMaterial3D')+'<br/>') +
		html_end()
		)
