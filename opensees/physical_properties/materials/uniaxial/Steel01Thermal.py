...
def makeXObjectMetaData():
	...
	at_Fy.description = (
		...
		html_par(html_href('http://openseesforfire.github.io/Subpages/MaterialCmds.html','Steel01Thermal')+'<br/>') +
		html_end()
		)
