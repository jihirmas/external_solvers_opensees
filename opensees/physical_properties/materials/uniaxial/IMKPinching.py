...
def makeXObjectMetaData():
	...
	def mka(name, group, descr, atype, adim = None, dval = None):
		...
		a.description = (
			...
			html_par(descr) +
			html_par(html_href('https://portwooddigital.com/2019/12/08/an-update-of-the-imk-models/','IMKPinching')+'<br/>') +
			html_end()
			)
		if adim is not None:
			a.dimension = adim
	...
	# uniaxialMaterial IMKPinching tag? Ke? Up_pos? Upc_pos? Uu_pos? Fy_pos? FmaxFy_pos? ResF_pos? Up_neg? Upc_neg?
	# Uu_neg? Fy_neg? FmaxFy_neg? ResF_neg? LamdaS? LamdaC? LamdaA? LamdaK? Cs? Cc? Ca? Ck? D_pos? D_neg? KappaF? KappaD?
	...
	KappaF = mka("KappaF", "Group", "", MpcAttributeType.Real)
	KappaD = mka("KappaD", "Group", "", MpcAttributeType.Real)

	xom = MpcXObjectMetaData()
	xom.name = 'IMKPinching'
	...
	xom.addAttribute(KappaF)
	xom.addAttribute(KappaD)
...
def writeTcl(pinfo):
	...
	# uniaxialMaterial IMKPinching tag? Ke? Up_pos? Upc_pos? Uu_pos? Fy_pos? FmaxFy_pos? ResF_pos? Up_neg? Upc_neg?
	# Uu_neg? Fy_neg? FmaxFy_neg? ResF_neg? LamdaS? LamdaC? LamdaA? LamdaK? Cs? Cc? Ca? Ck? D_pos? D_neg? KappaF? KappaD?
	str_tcl = '{}uniaxialMaterial IMKPinching {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {}\n'.format(
		pinfo.indent,
		tag,
		geta('Ke').real,
		geta('Up_pos').real,
