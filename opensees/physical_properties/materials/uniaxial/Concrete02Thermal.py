...
def makeXObjectMetaData():
	...
	at_fpc.description = (
		...
		html_par(html_href('http://openseesforfire.github.io/Subpages/MaterialCmds.html','Concrete02Thermal')+'<br/>') +
		html_end()
		)
...
def writeTcl(pinfo):
	...
	#uniaxialMaterial Concrete02Thermal $matTag $fpc $epsc0 $fpcu $epsU $lambda $ft $Ets
	...
	str_tcl = '{}uniaxialMaterial Concrete02Thermal {} {} {} {} {} {} {} {}\n'.format(
