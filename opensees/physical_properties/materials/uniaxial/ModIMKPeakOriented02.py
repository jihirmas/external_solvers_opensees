...
def makeXObjectMetaData():
	...
	def mka(name, group, descr, atype, adim = None, dval = None):
		...
		a.description = (
			...
			html_par(descr) +
			html_par(html_href('','ModIMKPeakOriented02')+'<br/>') +
			html_end()
			)
		if adim is not None:
			a.dimension = adim
	...
	C_Fp = mka("C_Fp", "Non-linear", "", MpcAttributeType.Real)
	C_Fn = mka("C_Fn", "Non-linear", "", MpcAttributeType.Real)
	...
	# uniaxialMaterial ModIMKPeakOriented02 tag? Ke?, alfaPos?, alfaNeg?, My_pos?, My_neg?
	# Ls?, Ld?, La?, Lk?, Cs?, Cd?, Ca?, Ck?, thetaPpos?, thetaPneg?, thetaPCpos?, thetaPCneg? 
	# ResfacPos?, ResfacNeg?, fracDispPos?, fracDispNeg?,DPos?, DNeg?, C_Fp?, C_Fn?, <nFactor?>

	xom = MpcXObjectMetaData()
	xom.name = 'ModIMKPeakOriented02'
	...
	xom.addAttribute(C_Fp)
	xom.addAttribute(C_Fn)
...
def writeTcl(pinfo):
	...
	str_tcl = '{}uniaxialMaterial ModIMKPeakOriented02 {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {}{}\n'.format(
			pinfo.indent,
			tag,
