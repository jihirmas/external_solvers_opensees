...
def makeXObjectMetaData():
	...
	at_Fy.description = (
		...
		html_par(html_href('http://openseesforfire.github.io/Subpages/MaterialCmds.html','Steel02Thermal')+'<br/>') +
		html_end()
		)
...
def writeTcl(pinfo):
	...
	#uniaxialMaterial Steel02Thermal $matTag $Fy $E $b $R0 $cR1 $cR2 <$a1 $a2 $a3 $a4 $sigInit>
