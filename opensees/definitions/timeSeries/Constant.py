...
def makeXObjectMetaData():
	...
	at_factor.description = (
		...
		html_par(html_href('http://opensees.berkeley.edu/wiki/index.php/Constant_TimeSeries','Constant TimeSeries')+'<br/>') +
		html_end()
		)
...
def evaluateFunctionAttribute(xobj):
	...
	if(xobj.name != 'Constant'):
		print('Error: invalid xobj type, expected "Constant", given "{}"'.format(xobj.name))
		return PyMpc.Math.mat()
