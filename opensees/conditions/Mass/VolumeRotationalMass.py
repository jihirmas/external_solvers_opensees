...
def fillConditionRepresentationData(xobj, pos, data):
	...
	sfx = xobj.getAttribute('F_mRx').string		#string function mass x
	sfy = xobj.getAttribute('F_mRy').string		#string function mass y
	sfz = xobj.getAttribute('F_mRz').string		#string function mass z
